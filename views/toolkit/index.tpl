    ...
    <div class="wrapper">
        ...
        <div class="button-toolbar">
            ...
            <a href="https://github.com/titon/toolkit/archive/<?= $toolkitVersion; ?>.zip" class="button large is-success hide-xsmall">
                Download
                <span class="button-suffix"><?= $toolkitVersion; ?></span>
            </a>

            <a href="<?= $this->url('toolkit.docs', ['version' => $toolkitVersion, 'path' => 'releases/2.1']); ?>" class="button large">
                Release Notes
            </a>
        </div>
    </div>
...
&lt;/div&gt;</code></pre>
    ...
    onCycle: function() {
        // Trigger logic
                    ...
                    <p>
                        <a href="<?= $this->url('toolkit.docs', ['version' => $toolkitVersion, 'path' => 'components/carousel']); ?>" class="button">
